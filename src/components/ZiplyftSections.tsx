...
/**
 * Shared Ziplyft content sections (hero through final CTA). Rendered by both the
 * standalone /ziplyft ad landing page (with its own minimal bar + sticky CTA) and
 * the main-site /services/ziplyft page (which gets the global header/footer).
 */
export default function ZiplyftSections() {
  return (
    <>
      {/* Hero */}
