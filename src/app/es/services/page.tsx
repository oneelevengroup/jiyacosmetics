...
export const metadata: Metadata = {
  title: "Servicios",
  description:
    "Arte quirúrgico y cuidado regenerativo: cirugía de párpados, rejuvenecimiento facial, tratamientos no quirúrgicos y restauración capilar con el Dr. Sumeet Jindal en Raleigh, NC.",
};
        ...
        >
          <div className="container-site">
            <div className="flex flex-col gap-3 border-b border-cream/15 pb-8">
              <Reveal>
                <span className="font-display text-xl text-gold/70">0{ci + 1}</span>
              </Reveal>
              <Reveal delay={0.06}>
